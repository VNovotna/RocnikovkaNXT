...
/**
 * The WaypointNav class uses the Navigator to execute the individual segments
 *
 * You can run the PilotParams sample to create a property file which sets the parameters of the Pilot to the dimensions
 * and motor connections for your robot.
 *
 * @author Dirk Sturzebecher - 20090131 - initial version revised 20090701 to use instead of extend a SimpleNavigator.
...
public class WaypointNav {
    ...
    public static void main(String[] args) throws IOException {
        ...
        float wheelDiameter = Float.parseFloat(pp.getProperty(PilotProps.KEY_WHEELDIAMETER, "43.2"));
        float trackWidth = Float.parseFloat(pp.getProperty(PilotProps.KEY_TRACKWIDTH, "128"));
